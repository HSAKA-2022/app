 ...
 */
const green = new LightState().rgb(103, 190, 97).on().brightness(100)
const red = new LightState().rgb(255, 56, 89).on().brightness(100)
const blue = new LightState().rgb(69, 162, 229).on().brightness(100)
const yellow = new LightState().rgb(254, 192, 9).on().brightness(100)
...
async function changeColors(newState) {
    ...
    const on = new LightState().on().brightness(100)
    const off = new LightState().off()
