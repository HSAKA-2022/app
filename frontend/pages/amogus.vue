                ...
                <div v-if="!state.isAdmin && state.isRegistered">
                    <div v-if="state.isAlive">
                        ...
                        <div v-if="new Date(state.startingAt) < new Date()">
                            ...
                            <p class="mt-4">
                                Als Imposter hingegen möchtest du möglichst viele Crewmates alleine antreffen um sie
                                dann zu "töten". Lass dir dazu den QR Code des Crewmates zeigen und scanne ihn. Beachte
                                jedoch, dass du nicht jederzeit beliebig töten kannst. Ihr müsst beide alleine sein und
                                es gibt einen Cooldown, den du nachschauen kannst.
                            </p>
                            <footer class="footer">
